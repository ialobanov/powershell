oh-my-posh init pwsh --config "~\AppData\Local\Programs\oh-my-posh\themes\illusi0n.omp.json" | Invoke-Expression
...
Function nvimclean {rm -r ~/AppData/Local/nvim-data/swap/ | rm -r ~/AppData/Local/nvim-data/shada/}
